<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = $conn->prepare("UPDATE products_db SET pname = :pname, price = :price, cp = :cp, img = :img WHERE id = :id");
        $sql->bindParam(":id", $id);
    ...
    <div class="container mt-5">
        ...
        <form action="edit.php" method="post" enctype="multipart/form-data">
            <?php
                if (isset($_GET['id'])) {
                        $id = $_GET['id'];
                        $stmt = $conn->query("SELECT * FROM products_db WHERE id = $id");
                        $stmt->execute();
                        $data = $stmt->fetch();
                }
            ?>
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $data['pname']; ?>" required class="form-control" name="pname" >
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $data['cp']; ?>" required class="form-control" name="cp">
                </div>
                <div class="mb-3">
